...
详见 [docs/user-manual/advanced/01-packaging.md](../user-manual/advanced/01-packaging.md) 与 [docs/technical/release/01-cli-packaging.md](../technical/release/01-cli-packaging.md)。
...
详见 [`docs/technical/sweep/02-sweep-architecture.md`](../technical/sweep/02-sweep-architecture.md) §10 + [`docs/user-manual/interactive/03-wizard-tasks.md`](../user-manual/interactive/03-wizard-tasks.md) §2。
