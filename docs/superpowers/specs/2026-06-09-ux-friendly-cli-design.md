...
| `docs/user-manual/interactive/01-repl-quickstart.md` (新) | 5 命令快速上手 | +120 |
| `docs/user-manual/interactive/02-repl-tour.md` (新) | REPL 全功能指南 | +150 |
| `docs/user-manual/interactive/03-wizard-tasks.md` (新) | 3 个 wizard 详细用法 | +200 |
| `docs/technical/architecture/02-core-modules.md` | 加 i18n + wizard 模块说明 | +30 |
| `docs/technical/sweep/03-sweep-usage.md` | 加 wizard sweep 一节 | +40 |
...
- [ ] 8.2 `docs/user-manual/interactive/01-repl-quickstart.md`(5 命令快速上手)
- [ ] 8.3 `docs/user-manual/interactive/02-repl-tour.md`(REPL 全功能)
- [ ] 8.4 `docs/user-manual/interactive/03-wizard-tasks.md`(3 个 wizard 详细)
- [ ] 8.5 `docs/technical/architecture/02-core-modules.md` 加 i18n + wizard
- [ ] 8.6 `docs/technical/sweep/03-sweep-usage.md` 加 wizard sweep 一节
