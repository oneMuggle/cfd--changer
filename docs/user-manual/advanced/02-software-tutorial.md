...
| 4 | 点 **生成** | 弹窗显示 `generated 6 cases -> ./sweep_cases` | 如果 4xx/5xx 看 [10-FAQ §Web GUI](../sweep/07-faq.md) |
...
> [04-扫描参数](../sweep/01-sweeping.md) 详述了"扫多个 case"姿势,本教程聚焦"单文件原地改"。
...
| 2 | Web GUI | 同上 | 10 分钟(含讲解) | [10-FAQ §Web GUI](../sweep/07-faq.md) |
| 3 | GitHub Actions | artifact zip | 15 分钟(配 CI) | [10-FAQ §CI](../sweep/07-faq.md) |
| 4 | CLI `set` + `diff` | 1 个新 .inp | 2 分钟 | [03-快速开始](../basics/03-quickstart.md) §姿势 A 之后 |
| 5 | Python API + sbatch | 6 个 job_id | 30 分钟(集群需排队) | [10-FAQ §集群](../sweep/07-faq.md) |

---

## 8. 关联章节

- 配置写法:[05-配置文件](../sweep/02-config-files.md) · 字段覆盖:[07-字段覆盖](../sweep/04-overrides.md) · CLI/API:[13-CLI 与 API 速查](../reference/02-cli-api-reference.md)
- 真实场景:[09-完整示例](../sweep/06-examples.md) · 排错:[10-FAQ](../sweep/07-faq.md) · 内部:[../technical/](../technical/)
