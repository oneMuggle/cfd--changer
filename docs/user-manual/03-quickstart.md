...
按提示一步步回答,回车接受默认。详见 [08-多入口 §3](08-multiple-uis.md)。
...
- 想扫更多参数,见 [04-扫描参数](04-sweeping.md)
- 想用 YAML 写配置,见 [05-配置文件 §YAML](05-config-files.md)
- 想改其他字段(不只是 alpha/beta/mach),见 [07-字段覆盖](07-overrides.md)
- 出错了?看 [10-常见问题](10-faq.md)
