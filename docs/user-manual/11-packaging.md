...
binary 报错信息和 Python 版一样(因为代码一样),见 [10-常见问题](10-faq.md)。
...
- 用法见 [03-快速开始](03-quickstart.md) / [05-配置文件](05-config-files.md)
- 出错见 [10-FAQ](10-faq.md)
- 想理解 binary 怎么打的见 [../technical/10-cli-packaging.md](../technical/10-cli-packaging.md)
