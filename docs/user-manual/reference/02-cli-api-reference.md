...
> 详细对比见 [08-多入口使用](../sweep/05-multiple-uis.md)。
...
| 给非命令行同事用 | FastAPI + 自家前端 | — | 浏览器即可,见 [08-多入口 §5](../sweep/05-multiple-uis.md) |
...
- 想知道 `sweep` 配置怎么写:[05-配置文件](../sweep/02-config-files.md)
- 想知道能扫哪些字段:[04-扫描参数](../sweep/01-sweeping.md)
- 字段值含义速查:[12-mcfd.inp 字段参考](01-mcfd-inp-field-reference.md)
- 多种入口横向对比:[08-多入口使用](../sweep/05-multiple-uis.md)
