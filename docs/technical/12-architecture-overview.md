...
| 入口 | 触发方式 | 对应源码 | 文档 |
|---|---|---|---|
| **Python API** | `from inp_tool import parse, write, diff, generate, ...` | `inp_tool/__init__.py` | [05-sweep-usage.md §1](05-sweep-usage.md) |
| **CLI** | `inp-tool <subcmd> ...`(安装后)/ `python -m inp_tool` | `inp_tool/cli.py:main` | [05-sweep-usage.md §2](05-sweep-usage.md) |
| **FastAPI** | `inp-tool-api` / `python -m inp_tool.api` | `inp_tool/api.py:main` | [05-sweep-usage.md §3](05-sweep-usage.md) |
| **Web GUI** | `inp-tool-api` 启动后访问 `/` | `inp_tool/web/index.html` | [07-sweep-friendly-uis.md §3](07-sweep-friendly-uis.md) |
...
| 文件 | 主题 |
|---|---|
| [03-sweep-overview](03-sweep-overview.md) | sweep 总览(背景/三入口/风险) |
| [04-sweep-architecture](04-sweep-architecture.md) | sweep 数据模型 + 主流程 |
