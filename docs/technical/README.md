...
| [19-equation-sweep-extend](19-equation-sweep-extend.md) | 方程感知扩展 (v0.10.0) | sweep 按 case 切方程/湍流/气体(枚举轴 + per-case 覆盖 + alias) | 当前主线 |
...
→ [05-sweep-usage](05-sweep-usage.md) 选你要的入口
→ [inp_tool/README.md](../../inp_tool/README.md) 安装与快速开始

### 3.2 我想理解 sweep 内部怎么工作

→ [03-sweep-overview](03-sweep-overview.md) 整体流程
→ [04-sweep-architecture](04-sweep-architecture.md) 数据模型 + `generate()` 主流程
→ [06-sweep-freestream](06-sweep-freestream.md) 公式细节
→ [源码 `inp_tool/inp_tool/sweep.py`](../../inp_tool/inp_tool/sweep.py) 234 行

### 3.3 我想贡献代码

→ [09-sweep-risks-roadmap §4](09-sweep-risks-roadmap.md) 贡献指南
→ [08-sweep-testing](08-sweep-testing.md) 测试结构 + 端到端验证清单
→ [项目根 `CLAUDE.md`](../../CLAUDE.md) 硬性约束(conda / Win7 / Py3.8)

### 3.4 我遇到了问题

→ [09-sweep-risks-roadmap §5](09-sweep-risks-roadmap.md) 已知"非 bug"
→ [06-sweep-freestream §4 方向假设](06-sweep-freestream.md) — 最常见的"值不对"问题
→ GitHub Issues(如有)
