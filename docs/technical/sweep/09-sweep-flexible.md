...
| `docs/technical/sweep/02-sweep-architecture.md` | 加 §1.5 CaseSpec 抽象 | +40 |
| `docs/technical/sweep/03-sweep-usage.md` | 加 §6 三种新模式 + 4 个完整示例 | +80 |
...
- [ ] 7.1 `02-sweep-architecture.md` 加 §1.5
- [ ] 7.2 `03-sweep-usage.md` 加 §6 + 4 个完整示例
