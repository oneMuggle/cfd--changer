...
详见 [03-sweep-usage.md](03-sweep-usage.md)。
...
详见 [05-sweep-friendly-uis.md](05-sweep-friendly-uis.md)。
...
详见 [02-sweep-architecture.md](02-sweep-architecture.md)。
...
详见 [07-sweep-risks-roadmap.md](07-sweep-risks-roadmap.md)。
...
详见 [06-sweep-testing.md](06-sweep-testing.md)。
...
详见 [07-sweep-risks-roadmap.md](07-sweep-risks-roadmap.md) §2。

## 10. 子文档索引

| 文件 | 主题 |
|---|---|
| [02-sweep-architecture.md](02-sweep-architecture.md) | 数据模型 / 流程图 / generate 主流程 |
| [03-sweep-usage.md](03-sweep-usage.md) | Python / CLI / FastAPI 详细用法 |
| [04-sweep-freestream.md](04-sweep-freestream.md) | 几何分解公式 / 适用条件 / 字段映射 |
| [05-sweep-friendly-uis.md](05-sweep-friendly-uis.md) | YAML / 交互式 / Web GUI / Shell 补全 |
| [06-sweep-testing.md](06-sweep-testing.md) | 测试结构 / 覆盖率 / 端到端 |
| [07-sweep-risks-roadmap.md](07-sweep-risks-roadmap.md) | 风险登记 / 后续工作 |
