...
| `docs/user-manual/01-quickstart.md` (新) | 5 命令快速上手 | +120 |
| `docs/user-manual/02-repl-tour.md` (新) | REPL 全功能指南 | +150 |
| `docs/user-manual/03-tasks.md` (新) | 3 个 wizard 详细用法 | +200 |
...
- [ ] 8.2 `docs/user-manual/01-quickstart.md`(5 命令快速上手)
- [ ] 8.3 `docs/user-manual/02-repl-tour.md`(REPL 全功能)
- [ ] 8.4 `docs/user-manual/03-tasks.md`(3 个 wizard 详细)
